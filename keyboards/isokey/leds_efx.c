...
const uint8_t uno[] = {
  ...
  0x01, 0x00, 0x00, 0x92, 0x01, 0x24, 0x00, 0x49, 0x9F, 0x89, 0x40, 0x00, 0x42, 0x3C, 0x43, 0x3C,
  0x66, 0x00, 0xA0, 0x02, 0xC0, 0x00, 0x9F, 0x8A, 0x40, 0x00, 0x42, 0x3C, 0x43, 0x3C, 0x66, 0x00,
  0xA0, 0x02, 0xC0, 0x00, 0x9F, 0x8B, 0x40, 0x00, 0x42, 0x3C, 0x43, 0x3C, 0x66, 0x00, 0xA0, 0x02,
  0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

const uint8_t due_addr[] = {0x0C, 0x15, 0x1C};
const uint8_t due[] = {
  0x01,0x00,0x00,0x20 ,0x00 ,0x04 ,0x00 ,0x02 ,0x00 ,0x10 ,0x00 ,0x80 ,0x00 ,0x01 ,0x00 ,0x08,
  0x00,0x40,0x00,0x92 ,0x01 ,0x24 ,0x00 ,0x49 ,0x9C ,0x03 ,0x9C ,0x85 ,0x40 ,0x00 ,0x9D ,0x80,
  0x40,0x3C,0x9D,0xC0 ,0x4C ,0x00 ,0xA0 ,0x02 ,0xC0 ,0x00 ,0x9F ,0x84 ,0x40 ,0x00 ,0xE0 ,0x80,
  0x40,0x0F,0x66,0x00 ,0xA0 ,0x02 ,0xC0 ,0x00 ,0x9F ,0x88 ,0x40 ,0x00 ,0xE0 ,0x80 ,0x40 ,0x0A,
...
void leds_efx_setLed(isokey_led_t led, uint8_t status) {
  ...
  if(led_map[led].pwm1 != 0)
    lp5569_setLed(led_map[led].addr, led_map[led].pwm1, lev);
  if(led_map[led].pwm2 != 0)
    lp5569_setLed(led_map[led].addr, led_map[led].pwm2, lev);
}
